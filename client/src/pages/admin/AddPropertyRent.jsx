...
export const AddPropertyRent = () => {
  ...
  const [form, setForm] = useState({ title: '', address: '', price: '', beds: '', baths: '', cars: '', status: 'For Rent', category: 'new' })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setForm({ title: '', address: '', price: '', beds: '', baths: '', cars: '', status: 'For Rent', category: 'new' })
        setImages([])
        setImageFiles([])
      }
    } catch (err) {
  ...
  return (
    <div>
        <h1 className="text-3xl font-serif text-[#111] mb-8 border-b pb-4">Add Property (Rent)</h1>
        
        <div className="bg-white p-8 shadow-sm rounded-sm">
            <p className="text-gray-500 italic mb-6">Use this form to add a new rental property to the database.</p>
            ...
            <form className="space-y-6 max-w-2xl" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input name="address" value={form.address} onChange={handleChange} type="text" className="w-full px-4 py-3 border border-gray-300 focus:outline-none focus:border-black transition-colors" placeholder="e.g. 18A/171 Gloucester Street, Sydney" />
                </div>
                ...
                <div>
                    ...
                    <input name="price" value={form.price} onChange={handleChange} type="text" className="w-full px-4 py-3 border border-gray-300 focus:outline-none focus:border-black transition-colors" placeholder="e.g. $850 per week" />
                </div>
